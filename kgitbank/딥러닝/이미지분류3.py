...
network.add(layers.Dense(256, activation='relu', input_shape=(150*150, )))
...
trainData = trainData.reshape((trainData.shape[0], 150*150))
testData = testData.reshape((testData.shape[0], 150*150))
